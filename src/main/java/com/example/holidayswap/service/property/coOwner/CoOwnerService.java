...
public interface CoOwnerService {
    ...
    CoOwnerResponse create(Long propertyId, Long userId, String roomId, CoOwnerRequest dtoRequest);

    CoOwnerResponse create(Long propertyId, Long userId, String roomId, CoOwnerRequest dtoRequest, List<MultipartFile> propertyImages);
