...
public interface InRoomAmenityMapper {
    ...
    InRoomAmenity toInRoomAmenity(InRoomAmenityRequest inRoomAmenityTypeRequest);

    InRoomAmenityResponse toInRoomAmenityResponse(InRoomAmenity inRoomAmenityType);
